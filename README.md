...
The architecture used is LSTM(Long Short Term Memory), a kind of recurrent neural network that specializes in dealing with sequential data avoiding traditional issues.
